...
const POSTS = [
  {
    ...
    date: "Field Notes · 02",
    excerpt:
      "From Adi Badri to the Rann — what the radar still remembers about a river the maps have forgotten.",
  },
  {
    tag: "Archaeology",
    ...
    date: "Field Notes · 07",
    excerpt:
      "Three submerged citadels, four hypotheses, one continuing question about a city under the sea.",
  },
  {
    tag: "Founder's Notes",
    title: "On listening to a temple before reading it",
    date: "Field Notes · 11",
    excerpt: "Why every Bhumivox journey begins with sixty silent minutes inside the garbhagriha.",
  },
  {
    tag: "Temple Stories",
    title: "The granite economy of the early Cholas",
    date: "Field Notes · 14",
    excerpt: "How a single river basin built a thousand temples in two hundred years.",
  },
  {
    tag: "Heritage Travel",
    title: "Why slow travel is the only travel left",
    date: "Field Notes · 16",
    excerpt: "Two weeks in Braj — and what fourteen days do that fourteen hours never can.",
  },
  {
    tag: "Vaishnav Tradition",
    title: "The eight maths of Udupi, and what they cook",
    date: "Field Notes · 19",
    excerpt: "Madhva's sattvik logistics, eight centuries on.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Long-form writing from <span className="italic text-primary">the field.</span>
          </>
        }
      ...
      <Section>
        <div className="grid gap-px bg-border/60 md:grid-cols-2">
          {POSTS.map((p) => (
            <article
              key={p.title}
              className="group cursor-pointer bg-background p-12 transition-colors hover:bg-card"
            >
