...
const TYPES = [
  {
    t: "Vaishnav Heritage",
    d: "Multi-generation Vaishnav pilgrimages with curatorial depth and strict sampradaya etiquette.",
  },
  {
    t: "Temple Trails",
    d: "Living temple culture — South, North, East — read through liturgy and stone.",
  },
  {
    t: "Archaeology Discovery",
    d: "Restricted-access digs led by field archaeologists; chronology over photo-ops.",
  },
  {
    t: "Family Heritage Journeys",
    d: "Slow, premium itineraries designed for three generations to travel and learn together.",
  },
  {
    t: "NRI Bharat Reconnection",
    d: "For travellers returning to a Bharat they half-remember and wish to fully understand.",
  },
  {
    t: "Premium Vegetarian Travel",
    d: "Strict sattvik kitchens, luxury comfort, no compromise on either side.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Six ways to enter <span className="italic text-primary">the same civilization.</span>
          </>
        }
