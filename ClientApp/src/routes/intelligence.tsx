...
export default function IntelPage() {
  useSeo({
    ...
    ogDescription: "The geospatial research workspace behind our civilizational journeys.",
  });
  const layers = [
    { k: "LiDAR", d: "Penetrates jungle canopy; reveals temple footprints and lost step-wells." },
    {
      k: "GIS",
      d: "Tirtha networks, pilgrim routes and paleo-river systems plotted as one graph.",
    },
    {
      k: "Satellite",
      d: "Multispectral imagery for vegetation, salinity, ancient settlement traces.",
    },
    ...
    <>
      ...
      <Section>
        <SectionLabel
          ...
          title={
            <>
              The land, <span className="italic text-primary">read in stack.</span>
            </>
          }
        />
