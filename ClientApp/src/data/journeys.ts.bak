...
export const JOURNEYS: JourneyDetail[] = [
  {
    ...
    itinerary: [
      {
        ...
        detail: "Private transfer, evening Yamuna aarti at Vishram Ghat with a historian briefing.",
      },
      {
        day: "Day 2",
        title: "Govardhan Parikrama",
        detail: "Pre-dawn parikrama on foot, breakfast at Radha Kund, afternoon at Daan Ghati.",
      },
      {
        day: "Day 3",
        title: "Nandgaon & Barsana",
        detail: "The hills of Krishna's childhood, with access to local Goswami families.",
      },
      {
        day: "Day 4",
        title: "Vrindavan Inner Circle",
        detail: "Nidhivan, Seva Kunj, and a private darshan at Banke Bihari before crowds.",
      },
      {
        day: "Day 5",
        title: "Gokul & Mahavan",
        detail: "Yamuna crossing, Raman Reti, and the archaeology of early Krishna devotion.",
      },
      {
        day: "Day 6",
        title: "Madhuban & Kosi",
        detail: "Lesser-walked sites of the parikrama with a Sanskritist.",
      },
      {
        day: "Day 7",
        title: "Mathura Museum & Departure",
        detail: "Curator-led tour of Kushan-era Krishna iconography, then onward.",
      },
    ],
    guideInfo: {
      name: "Chandru Ramesh",
      role: "Historian & Lead Guide",
      bio: "Independent historian focused on the textual and material history of sacred Bharat.",
    },
    inclusions: [
      "7 nights heritage stay",
      "All meals — sattvik",
      "Private transport",
      "Historian-led readings",
      "Entry & seva fees",
    ],
    ...
    departures: [
      {
        date: "2026-08-22",
        label: "22 Aug 2026 — Janmashtami Edition",
        seatsLeft: 2,
        totalSeats: 12,
        priceFrom: "₹4,80,000",
      },
      {
        date: "2026-10-18",
        label: "18 Oct 2026 — Sharad Purnima",
        seatsLeft: 6,
        totalSeats: 12,
        priceFrom: "₹4,20,000",
      },
      {
        date: "2027-03-14",
        label: "14 Mar 2027 — Holi Special",
        seatsLeft: 9,
        totalSeats: 12,
        priceFrom: "₹5,10,000",
      },
  ...
  },
  {
    ...
    itinerary: [
      {
        ...
        detail: "Sunset boat with a riverfront historian.",
      },
      {
        day: "Day 2",
        title: "Antara Griha Yatra",
        detail: "Inner-temple circuit with priestly access.",
      },
      {
        day: "Day 3",
        title: "Sarnath Field Day",
        detail: "Excavation walk with an ASI archaeologist.",
      },
      {
        day: "Day 4",
        title: "Drive to Prayagraj",
        detail: "Akshay Vat, Bharadwaj Ashram, and the Fort museum.",
      },
      {
        day: "Day 5",
        title: "Sangam Morning",
        detail: "Boat ritual at the confluence and Allahabad University archive visit.",
      },
      {
        day: "Day 6",
        title: "Return to Kashi",
        detail: "Manikarnika contemplation walk, private evening aarti.",
      },
      { day: "Day 7", title: "Departure", detail: "Morning Ganga walk and onward transfer." },
    ],
    guideInfo: {
      name: "Bhumivox Field Historians",
      role: "Scholar Guides",
      bio: "Sanskritists and archaeologists trained in Varanasi's scholarly tradition.",
    },
    inclusions: [
      "6 nights riverfront stay",
      "All meals",
      "Private boats",
      "ASI-led site walks",
      "Archive access",
    ...
    departures: [
      {
        date: "2026-09-10",
        label: "10 Sep 2026 — Pitru Paksha Edition",
        seatsLeft: 4,
        totalSeats: 10,
        priceFrom: "₹3,90,000",
      },
      {
        date: "2026-11-25",
        label: "25 Nov 2026 — Dev Deepawali",
        seatsLeft: 1,
        totalSeats: 10,
        priceFrom: "₹4,60,000",
      },
  ...
  },
  {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival Jamnagar → Dwarka",
        detail: "Coastal drive, sunset at Gomti Ghat.",
      },
      {
        day: "Day 2",
        title: "Dwarkadhish & Bet Dwarka",
        detail: "Boat crossing with a marine archaeologist.",
      },
      {
        day: "Day 3",
        title: "Submerged City Briefing",
        detail: "Private session on NIO underwater findings.",
      },
      {
        day: "Day 4",
        title: "Nageshwar & Coastal Sites",
        detail: "Jyotirlinga visit, evening at fisher villages.",
      },
      {
        day: "Day 5",
        title: "Porbandar Heritage",
        detail: "Sudama legend sites and the Arabian Sea coast.",
      },
      { day: "Day 6", title: "Departure", detail: "Onward to Jamnagar." },
    ],
    guideInfo: {
      name: "Marine Heritage Team",
      role: "Archaeologists",
      bio: "Specialists trained with the National Institute of Oceanography.",
    },
    inclusions: [
      "5 nights coastal stay",
      "All meals",
      "Private boats",
      "Marine archaeology briefing",
    ],
    ...
    departures: [
      {
        date: "2026-12-05",
        label: "05 Dec 2026 — Winter Coast",
        seatsLeft: 7,
        totalSeats: 12,
        priceFrom: "₹3,40,000",
      },
      {
        date: "2027-01-20",
        label: "20 Jan 2027 — Makar Sankranti",
        seatsLeft: 3,
        totalSeats: 12,
        priceFrom: "₹3,60,000",
      },
  ...
  },
  {
    ...
    itinerary: [
      ...
      {
        day: "Day 2",
        title: "Ayodhya Inner Walk",
        detail: "Janmasthan precinct with the historian.",
      },
      ...
      {
        day: "Day 7",
        title: "LiDAR Site Walk",
        detail: "Restricted research site, briefing in the field.",
      },
    ...
    departures: [
      ...
      {
        date: "2027-02-12",
        label: "12 Feb 2027 — Vasant Edition",
        seatsLeft: 2,
        totalSeats: 10,
        priceFrom: "₹5,40,000",
      },
  ...
  },
  {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival Delhi → Kurukshetra",
        detail: "Evening briefing on Saraswati research.",
      },
      {
        day: "Day 2",
        title: "Brahma Sarovar & Jyotisar",
        detail: "The Gita Upadesh site with a Sanskritist.",
      },
      {
        day: "Day 3",
        title: "Paleo-Channel Field Day",
        detail: "Visit to Saraswati paleo-river research sites.",
      },
    ...
    guideInfo: {
      name: "Bhumivox Research Team",
      role: "Field Historians",
      bio: "Geographers and Sanskritists working on the Saraswati corridor.",
    },
    ...
    departures: [
      {
        date: "2026-11-08",
        label: "08 Nov 2026 — Gita Jayanti Edition",
        seatsLeft: 3,
        totalSeats: 8,
        priceFrom: "₹2,80,000",
      },
  ...
  },
  {
    ...
    guideInfo: {
      name: "Cross-Strait Scholars",
      role: "Field Historians",
      bio: "Indian and Sri Lankan historians collaborating on the Ramayana corridor.",
    },
    ...
    departures: [
      {
        date: "2027-01-05",
        label: "05 Jan 2027 — New Year Crossing",
        seatsLeft: 4,
        totalSeats: 10,
        priceFrom: "₹7,80,000",
      },
      {
        date: "2027-02-22",
        label: "22 Feb 2027 — Maha Shivratri",
        seatsLeft: 8,
        totalSeats: 10,
        priceFrom: "₹7,60,000",
      },
